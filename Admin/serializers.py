...
#     class Meta:
#         model = User
#         fields = ['id', 'username', 'phone', 'email', 'is_active', 'is_staff', 'profile_image', 'logo',"subscriptions"]
...
#     user_phone = serializers.CharField(source="user.phone", read_only=True)  # assuming field exists in User model
...
#     class Meta:
#         model = Subscription
#         fields = ['id', 'user', 'user_id',"user_email","user_phone", 'plan', 'start_date', 'end_date', 'is_active', 'revoke']
